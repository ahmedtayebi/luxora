...
export default function Story() {
    return (
        <section id="story" className="bg-obsidian py-32">
      ...
      ════════════════════════════════════════════════════════ */}
            ...
            >
                {/* Giant decorative Arabic quote mark */}
                <span
                    aria-hidden="true"
                    ...
                    style={{ fontSize: '200px', color: 'rgba(201,168,76,0.05)' }}
                >
                    "
                </span>
      ...
      ════════════════════════════════════════════════════════ */}
            <div className="max-w-7xl mx-auto px-6 py-24">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    {/* ── Left column (text) — visually right in RTL ────── */}
                    <motion.div
                    ...
                    >
                        ...
                        {/* Heading */}
                        <h2 className="font-display text-[48px] text-ivory leading-tight mb-8">
                            وُلدت من شغف
                            <br />
                        ...
                        {/* Body paragraphs */}
                        <p className="font-body text-[15px] text-mist leading-[1.9] mb-6">
             في قلب الجزائر، ولدت لوكسورا لتكون جسراً يربط بين أصالة الأرض وعالم العطور الحديثة. رؤيتنا ليست مجرد ابتكار روائح، بل صياغة هويات عطرية فريدة تحاكي شخصية الإنسان الجزائري المعاصر: الطموح، المتجذر، والأنيق دوماً.
                        ...
                        <p className="font-body text-[15px] text-mist leading-[1.9]">
                            اليوم، تعتمد لوكسورا على أكثر من ١٢٠ مادة خام نادرة مصدرها ٦
                            قارات، كل قطعة تُصنع يدوياً في مشغلنا بباريس.
                        </p>
                        ...
                        <div className="flex items-center gap-0">
                            ...
                            <div className="flex flex-col items-center flex-1 text-center">
                                ...
                                <span className="font-body text-[12px] text-mist mt-2 tracking-wide">
                                    سنة خبرة
                                </span>
                            </div>
                    ...
                    >
                        ...
                        <div className="relative w-[400px] h-[400px] max-w-full">
                            ...
                            >
                                ...
                                {/* The rotated square corners are at N/E/S/W of the bounding box */}
      ...
      ════════════════════════════════════════════════════════ */}
            <div
                className="border-y py-16 overflow-hidden"
                style={{
        ...
        `}</style>
                ...
                <div className="marquee-track" aria-hidden="true">
                    ...
                    {[0, 1].map((n) => (
                        <span
                            key={n}
                            className="font-body text-[13px] tracking-[0.4em] whitespace-nowrap px-8"
