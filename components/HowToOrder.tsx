        ...
        >
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="font-body text-[15px] text-mist mt-4">
                ...
                <div className="relative">
                    ...
                    {/* Animated traveling dot (desktop) */}
                    <motion.div
                    ...
                    <div
                        className="lg:hidden absolute top-0 bottom-0 right-[32px] w-px z-0"
                        style={{ borderRight: '1px dashed rgba(201,168,76,0.15)' }}
                    />

                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 relative z-[2]">
                        {steps.map((step, i) => (
                            <motion.div
                                key={step.number}
                           ...
                           flex flex-col items-center lg:items-center"
                            >
                                ...
                                <span
                                    className="absolute top-4 right-4 font-display text-[64px] leading-none pointer-events-none select-none"
                             ...
                             group-hover:border-gold/40"
                                ...
                                <h3 className="font-display text-[22px] text-ivory mb-2 group-hover:text-gold transition-colors duration-300">
                                    {step.title}
                                </h3>
                ...
                <motion.div
                    ...
                    className="mt-16 rounded-[2px] border border-obsidian-border px-8 py-6"
                ...
                >
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        ...
                        <div className="flex items-center gap-4 flex-1 justify-center">
                            ...
                            <span className="font-display text-[18px] md:text-[20px] text-ivory whitespace-nowrap">
                                توصيل مضمون لـ ٥٨ ولاية
                            </span>
                        </div>

                        {/* Divider */}
                        <div className="hidden md:block w-px h-10 bg-gold/15 flex-shrink-0" />
